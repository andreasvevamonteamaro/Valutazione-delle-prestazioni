...
class Ssq1Sum {                                 /* sum of ...           */
    ...
    double traffic_intensity;                              /*traffic intensity*/

    double throughput;                              /*throughput*/

    double server_utilization;                              /*server utilization*/

    double avg_n_in_service;                              /*average number in service*/
...
class Ssq1 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            System.out.println("   input rate .............. =  " + f.format(1 / (sum.interarrival/index)));        // input rate (1/ avg interarrival time)
            System.out.println("   service rate ............ =  " + f.format(1 / (sum.service/index)));             //service rate ( 1/ avg service time)
